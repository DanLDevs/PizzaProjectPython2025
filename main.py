def main():
    """Main function to run the pizza builder program."""
    ...
    print_current_ingredients(user_pizza_dict)

# Function definitions remain outside the main function
...
def print_current_ingredients(user_pizza_dict):
    print()
    print('*' * 50)
    print()
...
# Define pizza_dict at module level
pizza_dict = {
    'ingredients': {
